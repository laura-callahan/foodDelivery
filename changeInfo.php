...
<br>
<?php
echo "<br>What are your food concerns?<form action=\"submitUpdateInfo.php\" method=\"post\"> <!-- go to index on sign up completion? --><div class=\"multiselect\" ><select name=\"allergies[]\" id=\"allergies[]\" multiple=\"multiple\" required><option value=\"gluten\">Gluten</option><option value=\"celiac\">Celiac</option><option value=\"lactose\">Lactose</option><option value=\"dairy\">Dairy</option><option value=\"egg\">Egg</option><option value=\"peanut\">Peanut</option><option value=\"corn\">Corn</option><option value=\"soy\">Soy</option><option value=\"vege\">Vegetarian</option><option value=\"vegan\">Vegan</option></select></div><br><br><div id=\"confirm0\"></div><div id=\"confirm\"></div><div class=\"buttonContainer\"><button class=\"btn waves-effect waves-light\" type=\"submit\" name=\"action\" id='signupSubmit'>Submit</button></div></form>";
?>
