...
foreach($_POST['allergies'] as $options){
  ...
  $sqlQ = "UPDATE FoodConcerns SET Lactose='".$lactose."', Egg='".$egg."', Egg='". $egg ."', Corn='".$corn."', Gluten='".$gluten."', Celiac='".$celiac."', Dairy='".$dairy."', Peanut='".$peanut."', Soy='".$soy."', Vegetarian='" . $vegetarian."', Vegan='".$vegan."' WHERE Username='" . $_SESSION['username'] . "';";
...
//print allergies
 echo '<table><tr><th>Gluten</th><th>Celiac</th><th>Lactose</th><th>Egg</th><th>Peanut</th><th>Corn</th><th>Soy</th><th>Vegetarian</th><th>Vegan</th></tr><tr><td>'. $allergies[0]. '</td><td>' . $allergies[1]. '</td><td>' . $allergies[2]. '</td><td>'. $allergies[3]. '</td><td>'. $allergies[4]. '</td><td>'. $allergies[5]. '</td><td>'. $allergies[6]. '</td><td>'. $allergies[7]. '</td><td>'. $allergies[8]. '</td></tr></table><br><br>';
 
 
 //get shipping info

//print shipping info 
// echo '<center><h4>Shipping Info</h4></center><br>';
// echo '<center></center>'
?>
